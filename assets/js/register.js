...
//évenement inpput => check function
document.querySelector("#registration_form_username").addEventListener('input', checkPseudo)
...
//on récupère l'élement d'affichage de l'entropie
