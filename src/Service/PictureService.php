...

{
    ...
    public function square(UploadedFile $picture, ?string $folder = "", ?int $width = 200):string{

        //on donne une nouveau nom à l'image
        ...
        if($pictureInfos === false){
            throw new Exception("Format images incorrecte");
        }
